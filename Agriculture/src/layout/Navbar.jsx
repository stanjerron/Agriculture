...
export default function Navbar({ toggleSidebar }) {
  ...
  return (
    <div className="h-16 w-full flex items-center justify-between px-4 md:px-6  shadow-sm relative">
      ...
      <div className="text-lg font-bold text-black md:text-xl uppercase">
        Agri Portal
      </div>
      ...
      <div className="flex items-center space-x-4">
        <div className="relative cursor-pointer">
          <Bell size={22} className="text-black hover:text-green-800 transition" />
        ...
        <div className="flex items-center cursor-pointer space-x-2" onClick={() => setOpen(!open)}>
          ...
          <span className="hidden sm:block text-black font-medium truncate max-w-[100px]">Jerron</span>
